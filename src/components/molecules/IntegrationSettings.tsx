    ...
    return (
        <GenericModal isOpen={isOpen} onClose={handleClose} modalStyle={modalStyle}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginLeft: '65px' }}>
                ...
                {recording && recording.integrations && recording.integrations.google_sheets && recording.integrations.google_sheets.sheet_id ? (
                    <>
                        <Alert severity="info">
                    ...
                    <>
                        {recording && !recording.integrations && !recording.integrations.google_sheets && !recording.integrations.google_sheets.email ? (
                            <>
