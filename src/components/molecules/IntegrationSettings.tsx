  ...
  return (
    <GenericModal isOpen={isOpen} onClose={handleClose} modalStyle={modalStyle}>
      ...
      >
        ...
        {recording?.integrations?.google_sheets?.sheet_id ? (
          <>
            <Alert severity="info">
              ...
              is appended to your{" "}
              {recording.integrations.google_sheets.sheet_name} Google Sheet.
              You can check the data updates{" "}
              <a
                href={`https://docs.google.com/spreadsheets/d/${recording.integrations.google_sheets.sheet_id}`}
                target="_blank"
                rel="noreferrer"
              >
                here
